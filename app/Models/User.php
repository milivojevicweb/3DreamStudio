...
class User{
    ...
    public function getAllUsers(){
        return \DB::table('user AS u')->join("userlevel AS ul","u.idUserLevel","=","ul.idUserLevel")->select("u.idUser","u.name","lastName","email","u.idUserLevel","ul.name AS level")->where("developer","=",0)->paginate(7);
    }
